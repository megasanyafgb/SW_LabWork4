...
«Автоматизована перевірка норм кодування деталізованого опису логічної моделі даних для підтримки безперервної інтеграції програмного забезпечення з використанням GitHub Actions»
...
Ознайомлення з особливостями норм кодування SQL та инструментами автоматичної перевірки відповідності коду нормам кодування (SQL Linters).

Навчання налаштувати скрипти GitHub Actions для автоматичної перевірки норм кодування при безперервній інтеграції програмного забезпечення.
